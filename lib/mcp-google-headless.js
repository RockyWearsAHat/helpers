  ...
  async function transferCookiesToHeadless(page) {
    try {
      ...
      if (googleCookies.length > 0) {
        ...
        // Ensure the base profile dir exists — only the -interactive/-headless
        // variants are mkdir'd elsewhere, so writing the shared cookie cache
        // here previously failed with ENOENT and verification never persisted.
