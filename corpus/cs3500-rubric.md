<!-- Source: /Users/alexwaldmann/bin/extraDocs/software-design.md (this repo, local filesystem — NOT GitHub).
     Original commit b6a1f97 "Install software-design instructions across audit assets" (2026-03-31),
     later folded into extraDocs/ by commit 4c3f94c "one engine — behavioral only; corpus -> extraDocs".
     Content unchanged since authored (238 lines both then and now) — this is the fuller, still-CS3500-branded
     copy; a sibling copy at copilot-config/instructions/software-design.instructions.md was later slimmed to a
     generic 5-point summary and is NOT this document. Verbatim below, no rewording. Captured 2026-07-09.
     GitHub search (prior attempt) found only C# course repos + a Maven pom.xml, none of which was this rubric —
     it lives locally in this repo, not on GitHub. -->
